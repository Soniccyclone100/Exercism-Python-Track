...
def value_of_card(card):
    ...
    if card in ('J', 'Q', 'K'):
        return 10
    elif card == 'A': # Simplified from: in ("A")
        return 1
    else:
        # If it reached here, it's a number card ('2' through '10')
        return int(card)
...
def higher_card(card_one, card_two):
    ...
    # If the values are equal, return a tuple of both original strings
